...
module tb;
  ...
  // running the test with setting as global scope
  // path that is uvm_test_top.data
  initial begin
...
// # KERNEL: UVM_INFO /home/runner/testbench.sv(43) @ 0: uvm_test_top.ENV.AGENT.comp2 [comp2] Data received by comp2: 256
// # KERNEL: UVM_INFO /home/runner/testbench.sv(21) @ 0: uvm_test_top.ENV.AGENT.comp1 [comp1] Data received by comp1: 256
